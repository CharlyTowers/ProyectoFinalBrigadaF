...
public class Edicion{
  ...
  public void editor(){
    ...
    try{    
      ...
      System.out.println("Escribe el numero de la linea que deseas modificar");
      ...
      while(linea != null){
        ...
        if(contador==texto){
          ...
          System.out.println("Que columna deseas modificar, desde la columna 1 hasta la 11");
          ...
          while(tokenizador.hasMoreTokens()){
            ...
            if(count==1){
              ...
              if(columnaM==1){
                System.out.println("Escribe el nombre completo del empleado");
              ...
              //Identifica la columna que se quiere modificar
              if(columnaM==4){
                System.out.println("Escribe los años de servicio");
              ...
              //Identifica la columna que se quiere modificar
              if(columnaM==6){
                System.out.println("Escribe el proyecto historico 1");
              ...
              //Identifica la columna que se quiere modificar
              if(columnaM==7){
                System.out.println("Escribe el proyecto historico 2");
              ...
              //Identifica la columna que se quiere modificar
              if(columnaM==8){
                System.out.println("Escribe el proyecto historico 3");
              ...
              //Identifica la columna que se quiere modificar
              if(columnaM==9){
                System.out.println("Escribe el proyecto vigente 1");
              ...
              //Identifica la columna que se quiere modificar
              if(columnaM==10){
                System.out.println("Escribe el proyecto vigente 2");
              ...
              //Identifica la columna que se quiere modificar
              if(columnaM==11){
                System.out.println("Escribe el proyecto vigente 3");
          ...
          System.out.println("La linea queda como:");
    ...
    System.out.println("Deseas continuar editando el archivo,1=si 2=no");
